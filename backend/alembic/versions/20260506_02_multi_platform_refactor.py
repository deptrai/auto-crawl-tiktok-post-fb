...
def upgrade() -> None:
    ...
    op.create_table('video_posts',
        ...
        sa.Column('platform', sa.Enum('facebook', 'youtube', 'instagram', name='platformtype'), nullable=False),
        sa.Column('status', sa.Enum('pending', 'downloading', 'ready', 'posted', 'failed', name='videostatus'), nullable=False, server_default='pending'),
